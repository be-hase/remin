...
var GroupSlowLogPager = React.createClass({
    render: function() {
        var slowLog = this.props.slowLog;
        var pathBase = "#/group/" + this.props.group.group_name + "/slowlog/";
        ...
        return (
            <div className="group-slowlog-pager-components clearfix">
...
module.exports = GroupSlowLogPager;
