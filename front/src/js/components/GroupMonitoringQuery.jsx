...
var GroupMonitoringQuery = React.createClass({
    getInitialState: function () {
        ...
        return {
            ...
            hostAndPortsValues: query.hostAndPorts,
    ...
    render: function() {
        ...
        var hostAndPortsOptions = _.map(group.nodes, function(val) {
            return {value: val.host_and_port, label: val.host_and_port};
        });
        var hostAndPortsValues = _.filter(this.state.hostAndPortsValues.split(','), function(val) {
            return !!val;
        });
        ...
        return (
            <div className="group-monitoring-query-components">
                    ...
                    <div className="modal-dialog">
                        <div className="modal-content">
                            <div className="modal-header">
                                ...
                                <h4 className="modal-title">Select nodes</h4>
                            </div>
                            <div className="modal-body">
                                <div className="form-group">
                                    <label>Nodes</label>
                                    <Select name="nodes" multi={true} value={hostAndPortsValues} delimiter="," options={hostAndPortsOptions} onChange={this.handleChangeNodesSelect}/>
                                </div>
                            </div>
    ...
    handleChangeAutoRefreshCheckbox: function(event) {
        ...
        GroupActions.setNodeMetricsQueryOnlyAutoRefresh(this.props.group.group_name, event.target.checked);
    },
    ...
    autoRefresh: function() {
        ...
        GroupActions.setNodeMetricsQuery(this.props.group.group_name, query);
    },
    handleChangeNodesSelect: function(val) {
        this.setState({
            hostAndPortsValues: val
        });
    },
    ...
    handleGetClick: function(event) {
        ...
        var query = {
            ...
            hostAndPorts: this.state.hostAndPortsValues,
            fields: this.state.metricsNameValues,
            isAutoRefresh: false
        };
        if (!query.hostAndPorts) {
            Utils.showAlert({
...
module.exports = GroupMonitoringQuery;
